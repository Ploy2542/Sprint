<?php
	...
	mysqli_query($conn,"insert into meeting (title, head,numattend,listname,start,end,addequipment,remark,meetfile) values ('$title', '$head','$numattend', '$listname','$start', '$end','$addequipment', '$remark','$meetfilelocation')");
